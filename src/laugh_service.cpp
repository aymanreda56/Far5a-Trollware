...
int Laugh()
{
  ...
  */
    ...
    std::string parentPath = path.parent_path().string() + std::string("\\sound.exe");  //this line translates to the absolute path of the executable "sound.exe" which is inside the same directory of this current executable file
